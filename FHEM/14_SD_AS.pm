##############################################
# $Id: 14_SD_AS.pm 351 2020-12-21 20:16:11Z elektron-bbs $
#
...
#
# 2014 - S.Butzek, N.Butzek
# 2020 - elektron-bbs, HomeAutoUser
...
sub SD_AS_Parse {
  ...
  if ($model eq 'lightHiRange') { # 3
    ...
    return q{} if ($Sigval > 100 || $Sigval < -60);
    ...
    return q{} if ($Sigval > 100 || $Sigval < 0);
    $val = "H: $Sigval";
  }
...
<h3>SD_AS</h3>
<ul>
  The SD_AS module interprets Arduino based sensors received via SIGNALduino
  <br><br>
...
<h3>SD_AS</h3>
<ul>
  Das SD_AS Modul dekodiert vom SIGNALduino empfangene Nachrichten von Arduino basierenden Sensoren.
  <br><br>
